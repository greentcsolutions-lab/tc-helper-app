  ...
  const features = [
    {
      ...
      listedKit: "$9.99 per file",
      trackxi: "$39/month base",
      openToClose: "$99/month",
    },
    {
    ...
    },
    {
      ...
      tcHelper: "20 files",
      listedKit: "1 file per purchase",
      trackxi: "10 transactions",
      openToClose: "Unlimited",
    },
    {
      name: "Custom Tasks",
      tcHelper: "100 custom tasks + AI generated",
      listedKit: "doesn't provide (AI only)",
      trackxi: "doesn't provide",
      openToClose: "Yes", // Open to close has "task management", assuming it includes custom tasks
    },
    {
      ...
      trackxi: "doesn't provide",
      openToClose: "Yes", // Included in "task management"
    },
    {
      name: "Calendar Sync",
    ...
    },
    {
      ...
      tcHelper: "In the works",
      listedKit: "AI assistant generates emails",
      trackxi: "Email integration",
      openToClose: "Scheduled emails",
    },
    {
      name: "AI Data Usage for Model Training",
      tcHelper: "NOT used for AI model training",
      listedKit: "Uses user data to train Ava",
      trackxi: "doesn't provide",
      openToClose: "doesn't provide",
    },
    {
