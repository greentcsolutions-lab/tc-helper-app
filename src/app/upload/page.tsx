...
import { UploadLayout } from "@/components/ui/upload/upload-layout";
...
export default async function UploadPage() {
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Extracts in ~30 seconds</p>
            </div>
          </div>
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <UploadLayout mainContent={mainContent} sidebar={sidebarContent} />
    </div>
  );
}
